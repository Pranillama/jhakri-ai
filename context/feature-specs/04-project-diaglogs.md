...
- slug validation: a name that produces an empty slug (only symbols/whitespace) blocks submit and shows an inline error hint (added beyond original spec)
...
- input auto-focuses
- Enter submits
- same empty-slug validation as Create (added beyond original spec)
