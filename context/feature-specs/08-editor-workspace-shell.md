...
> Update: sharing was added later in `09-share-diaglog.md`. The Share button in
> `editor-navbar.tsx` and the `ShareDialog` wired in `editor-room-shell.tsx`
> belong to that step, not this one.
